#!/usr/bin/env python3
"""Build routine stability watch closure report."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Build routine stability watch closure report")
    parser.add_argument("--routine-release-cycle-stability-report", required=True, type=Path)
    ...
    args.out_md.write_text(render_validation_routine_stability_watch_closure_markdown(payload), encoding="utf-8")
