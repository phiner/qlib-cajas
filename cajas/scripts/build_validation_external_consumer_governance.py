#!/usr/bin/env python3
"""Build external consumer governance maintenance report."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Build external consumer governance report")
    ...
    args.out_md.write_text(render_validation_external_consumer_governance_markdown(payload), encoding="utf-8")
