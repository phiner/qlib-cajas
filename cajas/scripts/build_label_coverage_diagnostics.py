...
from cajas.reports.dataset_quality_research import build_label_coverage_diagnostics, render_label_coverage_markdown  # noqa: E402
...
def main() -> int:
    ...
    report = build_label_coverage_diagnostics(
    ...
    out_md.write_text(render_label_coverage_markdown(diagnostics=report), encoding="utf-8")
