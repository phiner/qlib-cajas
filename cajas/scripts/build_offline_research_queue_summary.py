...
from cajas.reports.dataset_quality_research import (  # noqa: E402
    build_offline_research_queue_summary,
    render_offline_research_queue_summary_markdown,
)
from cajas.reports.runtime_io_summary import safe_json_write  # noqa: E402


def main(argv: list[str] | None = None) -> int:
    p = argparse.ArgumentParser(description="Build offline research queue summary from dataset diagnostics.")
    ...
    report = build_offline_research_queue_summary(
    ...
    out_md.write_text(render_offline_research_queue_summary_markdown(queue=report), encoding="utf-8")
