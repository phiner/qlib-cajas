#!/usr/bin/env python3
"""Build EURUSD four-layer market-state sample export artifacts."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Build EURUSD market-state four-layer sample export")
    ...
    args.output_md.write_text(render_market_state_sample_export_markdown(report, args.output_csv), encoding="utf-8")
