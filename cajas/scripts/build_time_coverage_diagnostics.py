...
from cajas.reports.dataset_quality_research import build_time_coverage_diagnostics, render_time_coverage_markdown  # noqa: E402
from cajas.reports.runtime_io_summary import safe_json_write  # noqa: E402


def main(argv: list[str] | None = None) -> int:
    p = argparse.ArgumentParser(description="Build time/session coverage diagnostics (offline research only).")
    ...
    report = build_time_coverage_diagnostics(
    ...
    out_md.write_text(render_time_coverage_markdown(diagnostics=report), encoding="utf-8")
