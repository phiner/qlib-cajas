...
from cajas.reports.dataset_quality_research import build_dataset_quality_report, render_dataset_quality_report_markdown  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    ...
    out_md.write_text(render_dataset_quality_report_markdown(report=report), encoding="utf-8")
    print(json.dumps({"status": "ok", "out_json": str(out_json), "out_md": str(out_md), "row_count": report["row_count"]}, ensure_ascii=True))
    return 0
